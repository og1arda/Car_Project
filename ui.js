...
UI.prototype.dissplayMessages = function (message, type) {
    const cardBody = document.querySelector(".card-body") //it is choose to first card-body class.
    //Alert Div
...
UI.prototype.clearAllCarsFromUI=function(){
    ...
    // carList.innerHTML="" second option
}